...
class Blog1 extends Component {
  render() {
    ...
    <main>
    <h1><center>Diwali, Festival of Lights</center></h1>
    <center><img className="blog" src={process.env.PUBLIC_URL + '/Diwali.jpg' } alt="Diwali"  /></center>
