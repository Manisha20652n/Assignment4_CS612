...
class Blog3 extends Component {
  render() {
    ...
    <main>
    <h1><center>Navratri</center></h1>
    <center><img className="blog" src={process.env.PUBLIC_URL + '/Dandiya2.jpg' } alt="Dandiya"  /></center>
    ...
    <p><b>Significance of Each Day</b>

	Navadurga - The nine goddesses worshipped in Navaratri.
The festival is associated to the prominent battle that took place between Durga and demon Mahishasura and celebrates the victory of Good over Evil.[18] These nine days are solely dedicated to Goddess Durga and her nine Avatars - the Navadurga. Each day is associated to an incarnation of the goddess:
...
Day 9 - Sidhidatri
On the last day of the festival also known as Navami, people pray to Siddhidhatri. Sitting on a lotus, she is believed to possess and bestows all types of Siddhis. Here she has four hands. Also known as SriLakshmi Devi. The light blue color of the day portrays an admiration towards nature's beauty.    </p>
    </main>
    );
  }
}
